...
offset_list off_070101 = {
    ...
    .GAD_IRETQ = (0xFFFFFFFF80FB7321 - KERNEL_TEXT),
    .GAD_POP_RAX_RET = (0xFFFFFFFF80E816B9 - KERNEL_TEXT),
    .GAD_POP_RDI_RET = (0xFFFFFFFF85214A47 - KERNEL_TEXT),
    .GAD_POP_RSI_RET = (0xFFFFFFFF80EDDA4A - KERNEL_TEXT),
    .GAD_POP_RDX_RET = (0xFFFFFFFF81059DDF - KERNEL_TEXT),
    .GAD_POP_RCX_RET = (0xFFFFFFFF8309A688 - KERNEL_TEXT),
    .GAD_POP_RSP_RET = (0xFFFFFFFF80FB42BA - KERNEL_TEXT),
    .GAD_WRMSR_RET = (0xFFFFFFFF8084C838 - KERNEL_TEXT),
    // .GAD_MOV_QWORD_PTR_RDI_RSI_POP_RBP_RET not needed
    // .HOOK_ACPI_WAKEUP_MACHDEP not needed
    .KERNEL_CODE_CAVE = 0x500,
    .FUN_PRINTF = (0xFFFFFFFF806CC530 - KERNEL_TEXT),
    ...
    .KERNEL_UART_OVERRIDE = (0xFFFFFFFF822C3338 - KERNEL_TEXT),
    .KERNEL_CFI_CHECK = (0xFFFFFFFF806854A0 - KERNEL_TEXT),
    .G_VBIOS = (0xFFFFFFFF8475B771 - KERNEL_TEXT),
    .FUN_TRANSMITTER_CONTROL = (0xFFFFFFFF80DAECC0 - KERNEL_TEXT),
    .FUN_MP3_INITIALIZE = (0xFFFFFFFF80BCB5C0 - KERNEL_TEXT),
    .FUN_MP3_INVOKE = (0xFFFFFFFF80BCA380 - KERNEL_TEXT),
    .PS5_WIFI_FW_OFFSET = (0xFFFFFFFF83A89C7F - KERNEL_TEXT),
    .PS5_WIFI_FW_SIZE = 497636,
};
